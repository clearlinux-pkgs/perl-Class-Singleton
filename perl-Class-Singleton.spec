...
cp %{_builddir}/Class-Singleton-%{version}/Copying %{buildroot}/usr/share/package-licenses/perl-Class-Singleton/18eaf66587c5eea277721d5e569a6e3cd869f855 || :
cp %{_builddir}/Class-Singleton-%{version}/LICENCE %{buildroot}/usr/share/package-licenses/perl-Class-Singleton/2a7c640d77e195b3674ec8e5e126b3ac7a1ce1a1 || :
if test -f Makefile.PL; then
